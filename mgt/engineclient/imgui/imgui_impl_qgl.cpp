// dear imgui: Renderer for Quake OpenGL 1.1 (legacy OpenGL, fixed pipeline, dynamic linkage)
...
// The QGL code is unable to reset attributes or even call e.g. "glUseProgram(0)" because they don't exist in that API.
