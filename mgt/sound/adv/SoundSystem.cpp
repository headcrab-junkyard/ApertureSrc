...
CSoundSystem soundSystemLocal;
ISoundSystem *soundSystem = &soundSystemLocal;
...
/*
========================
CSoundSystem::Restart
========================
*/
void CSoundSystem::Restart()
{
...
/*
========================
CSoundSystem::InitStreamBuffers
========================
*/
void CSoundSystem::InitStreamBuffers()
{
...
/*
========================
CSoundSystem::FreeStreamBuffers
========================
*/
void CSoundSystem::FreeStreamBuffers()
{
	streamBufferMutex.Lock();
...
/*
========================
CSoundSystem::ObtainStreamBuffer

Get a stream buffer from the free pool, returns NULL if none are available
========================
*/
CSoundSystem::bufferContext_t *CSoundSystem::ObtainStreamBufferContext()
{
...
/*
========================
CSoundSystem::ReleaseStreamBuffer

Releases a stream buffer back to the free pool
========================
*/
void CSoundSystem::ReleaseStreamBufferContext(bufferContext_t *bufferContext)
{
	streamBufferMutex.Lock();
...
/*
========================
CSoundSystem::AllocSoundWorld
========================
*/
ISoundWorld *CSoundSystem::AllocSoundWorld(IRenderWorld *rw)
{
	CSoundWorld *local = new(TAG_AUDIO) CSoundWorld;
...
/*
========================
CSoundSystem::FreeSoundWorld
========================
*/
void CSoundSystem::FreeSoundWorld(ISoundWorld *sw)
{
	CSoundWorld *local = static_cast<CSoundWorld *>(sw);
...
/*
========================
CSoundSystem::SetPlayingSoundWorld

Specifying NULL will cause silence to be played.
========================
*/
void CSoundSystem::SetPlayingSoundWorld(ISoundWorld *soundWorld)
{
	if(currentSoundWorld == soundWorld)
	{
		return;
	}
	CSoundWorld *oldSoundWorld = currentSoundWorld;

	currentSoundWorld = static_cast<CSoundWorld *>(soundWorld);
...
/*
========================
CSoundSystem::GetPlayingSoundWorld
========================
*/
ISoundWorld *CSoundSystem::GetPlayingSoundWorld()
{
...
/*
========================
CSoundSystem::OnReloadSound
========================
*/
void CSoundSystem::OnReloadSound(const idDecl *sound)
{
	for(int i = 0; i < soundWorlds.Num(); i++)
	{
...
/*
========================
CSoundSystem::GetIXAudio2
========================
*/
void *CSoundSystem::GetIXAudio2() const
{
...
/*
========================
CSoundSystem::SoundTime
========================
*/
int CSoundSystem::SoundTime() const
{
	return soundTime;
}
...
/*
========================
CSoundSystem::AllocateVoice
========================
*/
idSoundVoice *CSoundSystem::AllocateVoice(const idSoundSample *leadinSample, const idSoundSample *loopingSample)
{
...
/*
========================
CSoundSystem::FreeVoice
========================
*/
void CSoundSystem::FreeVoice(idSoundVoice *voice)
{
...
/*
========================
CSoundSystem::LoadSample
========================
*/
idSoundSample *CSoundSystem::LoadSample(const char *name)
{
...
/*
========================
CSoundSystem::StopVoicesWithSample

A sample is about to be freed, make sure the hardware isn't mixing from it.
========================
*/
void CSoundSystem::StopVoicesWithSample(const idSoundSample *const sample)
{
...
========================
*/
cinData_t CSoundSystem::ImageForTime(const int milliseconds, const bool waveform)
{
	cinData_t cd;
	cd.imageY = NULL;
	cd.imageCr = NULL;
...
/*
========================
CSoundSystem::BeginLevelLoad
========================
*/
void CSoundSystem::BeginLevelLoad()
{
...
/*
========================
CSoundSystem::Preload
========================
*/
void CSoundSystem::Preload(idPreloadManifest &manifest)
{
...
/*
========================
CSoundSystem::EndLevelLoad
========================
*/
void CSoundSystem::EndLevelLoad()
{
	insideLevelLoad = false;

	common->Printf("----- CSoundSystem::EndLevelLoad -----\n");
	int start = Sys_Milliseconds();
	int keepCount = 0;
	int loadCount = 0;
...
========================
*/
void CSoundSystem::PrintMemInfo(MemInfo_t *mi)
{
}
