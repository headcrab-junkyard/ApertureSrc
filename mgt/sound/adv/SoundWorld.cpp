...
/*
========================
CSoundWorld::AllocSoundEmitter

This is called from the main thread.
========================
*/
ISoundEmitter *CSoundWorld::AllocSoundEmitter()
{
	CSoundEmitter *emitter = emitterAllocator.Alloc();
...
/*
========================
CSoundWorld::AllocSoundChannel
========================
*/
CSoundChannel *CSoundWorld::AllocSoundChannel()
{
...
/*
========================
CSoundWorld::FreeSoundChannel
========================
*/
void CSoundWorld::FreeSoundChannel(CSoundChannel *channel)
{
	channel->Mute();
...
/*
========================
CSoundWorld::CurrentShakeAmplitude
========================
*/
float CSoundWorld::CurrentShakeAmplitude()
{
...
/*
========================
CSoundWorld::PlaceListener
========================
*/
void CSoundWorld::PlaceListener(const idVec3 &origin, const idMat3 &axis, const int id)
{
	if(writeDemo)
	{
...
/*
========================
CSoundWorld::OnReloadSound
========================
*/
void CSoundWorld::OnReloadSound(const idDecl *shader)
{
	for(int i = 0; i < emitters.Num(); i++)
	{
...
/*
========================
CSoundWorld::EmitterForIndex
========================
*/
ISoundEmitter *CSoundWorld::EmitterForIndex(int index)
{
	...
	{
		idLib::Error("CSoundWorld::EmitterForIndex: %i >= %i", index, emitters.Num());
	}
...
/*
========================
CSoundWorld::ClearAllSoundEmitters
========================
*/
void CSoundWorld::ClearAllSoundEmitters()
{
	for(int i = 0; i < emitters.Num(); i++)
	{
		emitters[i]->Reset();
...
/*
========================
CSoundWorld::StopAllSounds

This is called from the main thread.
========================
*/
void CSoundWorld::StopAllSounds()
{
	for(int i = 0; i < emitters.Num(); i++)
	{
		emitters[i]->Reset();
...
/*
========================
CSoundWorld::PlayShaderDirectly
========================
*/
int CSoundWorld::PlayShaderDirectly(const char *name, int channel)
{
...
========================
*/
void CSoundWorld::Skip(int time)
{
...
/*
========================
CSoundWorld::GetSoundTime
========================
*/
int CSoundWorld::GetSoundTime()
{
	if(isPaused)
	{
...
void CSoundWorld::ResolveOrigin(const int stackDepth, const soundPortalTrace_t *prevStack, const int soundArea, const float dist, const idVec3 &soundOrigin, idSoundEmitterLocal *def)
{
...
/*
========================
CSoundWorld::StartWritingDemo
========================
*/
void CSoundWorld::StartWritingDemo(idDemoFile *demo)
{
	writeDemo = demo;
...
/*
========================
CSoundWorld::StopWritingDemo
========================
*/
void CSoundWorld::StopWritingDemo()
{
	writeDemo = NULL;
}
...
/*
========================
CSoundWorld::ProcessDemoCommand
========================
*/
void CSoundWorld::ProcessDemoCommand(idDemoFile *readDemo)
{
	if(!readDemo)
	{
		return;
	...
	case SCMD_ALLOC_EMITTER:
	{
		...
		{
			common->Error("CSoundWorld::ProcessDemoCommand: bad emitter number");
		}
		if(index == emitters.Num())
		{
...
=================
*/
void CSoundWorld::AVIOpen(const char *, const char *)
{
}

/*
=================
CSoundWorld::AVIClose
=================
*/
void CSoundWorld::AVIClose()
{
}

/*
=================
CSoundWorld::WriteToSaveGame
=================
*/
void CSoundWorld::WriteToSaveGame(idFile *savefile)
{
	struct helper
	{
...
/*
=================
CSoundWorld::ReadFromSaveGame
=================
*/
void CSoundWorld::ReadFromSaveGame(idFile *savefile)
{
	struct helper
	{
...
/*
=================
CSoundWorld::FadeSoundClasses

fade all sounds in the world with a given shader soundClass
to is in Db, over is in seconds
=================
*/
void CSoundWorld::FadeSoundClasses(const int soundClass, const float to, const float over)
{
	if(soundClass < 0 || soundClass >= SOUND_MAX_CLASSES)
	{
		common->Error("CSoundWorld::FadeSoundClasses: bad soundClass %i", soundClass);
		return;
	}
...
/*
=================
CSoundWorld::SetSlowmoSpeed
=================
*/
void CSoundWorld::SetSlowmoSpeed(float speed)
{
	slowmoSpeed = speed;
}
...
/*
=================
CSoundWorld::SetEnviroSuit
=================
*/
void CSoundWorld::SetEnviroSuit(bool active)
{
