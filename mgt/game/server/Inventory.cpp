...
==============
*/
void CInventory::GivePowerUp(idPlayer *player, int powerup, int msec)
{
	powerups |= 1 << powerup;
...
==============
*/
void CInventory::GetPersistantData(idDict &dict)
{
	int i;
	int num;
	idDict *item;
...
==============
*/
void CInventory::RestoreInventory(idPlayer *owner, const idDict &dict)
{
	int i;
	int num;
	idDict *item;
...
==============
*/
ammo_t CInventory::AmmoIndexForAmmoClass(const char *ammo_classname) const
{
...
==============
*/
int CInventory::MaxAmmoForAmmoClass(const idPlayer *owner, const char *ammo_classname) const
{
...
==============
*/
const char *CInventory::AmmoPickupNameForIndex(ammo_t ammonum) const
{
	return CBaseWeapon::GetAmmoPickupNameForNum(ammonum);
}
...
==============
*/
int CInventory::WeaponIndexForAmmoClass(const idDict &spawnArgs, const char *ammo_classname) const
{
	int i;
...
==============
*/
ammo_t CInventory::AmmoIndexForWeaponClass(const char *weapon_classname, int *ammoRequired)
{
	const idDeclEntityDef *decl = gameLocal.FindEntityDef(weapon_classname, false);
	if(!decl)
	{
...
==============
*/
void CInventory::AddPickupName(const char *name, idPlayer *owner)
{ //_D3XP
...
==============
*/
bool CInventory::Give(idPlayer *owner, const idDict &spawnArgs, const char *statname, const char *value,
...
===============
*/
void CInventory::Drop(const idDict &spawnArgs, const char *weapon_classname, int weapon_index)
{
...
===============
*/
int CInventory::HasAmmo(ammo_t type, int amount)
{
	if((type == 0) || !amount)
	{
...
===============
*/
int CInventory::HasAmmo(const char *weapon_classname, bool includeClip, idPlayer *owner)
{ //_D3XP
	int ammoRequired;
...
===============
*/
bool CInventory::HasEmptyClipCannotRefill(const char *weapon_classname, idPlayer *owner)
{
...
===============
*/
bool CInventory::UseAmmo(ammo_t type, int amount)
{
...
*/
void CInventory::InitRechargeAmmo(idPlayer *owner)
{
...
*/
void CInventory::RechargeAmmo(idPlayer *owner)
{
...
===============
*/
bool CInventory::CanGive(idPlayer *owner, const idDict &spawnArgs, const char *statname, const char *value)
{
	if(!idStr::Icmp(statname, "ammo_bloodstone"))
	{
...
===============
*/
void CInventory::SetClipAmmoForWeapon(const int weapon, const int amount)
{
	clip[weapon] = amount;
}
...
===============
*/
void CInventory::SetInventoryAmmoForType(int ammoType, const int amount)
{
...
===============
*/
int CInventory::GetClipAmmoForWeapon(const int weapon) const
{
...
===============
*/
int CInventory::GetInventoryAmmoForType(const int ammoType) const
{
...
===============
*/
void CInventory::WriteAmmoToSnapshot(idBitMsg &msg) const
{
	for(int i = 0; i < AMMO_NUMTYPES; i++)
	{
...
===============
*/
void CInventory::ReadAmmoFromSnapshot(const idBitMsg &msg, const int ownerEntityNumber)
{
	for(int i = 0; i < ammo.Num(); i++)
	{
...
===============
*/
void CInventory::SetRemoteClientAmmo(const int ownerEntityNumber)
{
	for(int i = 0; i < ammo.Num(); ++i)
	{
