...
{
	M_walkmove (self, self->s.angles[YAW], dist); // TODO: was walkmove
	//walkmove(self.angles_y, dist); // for ai_forward
	//walkmove((self.angles_y + 180), dist); // for ai_back
	/* // for ai_pain
	 ai_back(dist);
/*
	local float	away;
...
*/
	*/
	//walkmove(self.ideal_yaw, dist); // for ai_painforward
}
