...
==============
*/
void t_movetarget(entvars_t *self)
{
	entvars_t temp;
	...
	if(self->classname == "monster_ogre")
		gpEngine->pfnEmitSound(self, CHAN_VOICE, "ogre/ogdrag.wav", 1, ATTN_IDLE);// play chainsaw drag sound
...
void movetarget_f(entvars_t *self)
{
	if(!self->targetname)
	...
	gpEngine->pfnSetSize(self, '-8 -8 -8', '8 8 8');
};

/*QUAKED path_corner (0.5 0.3 0) (-8 -8 -8) (8 8 8)
Monsters will continue walking towards the next target corner.
*/
void path_corner(entvars_t *self)
{
	movetarget_f(self);
};