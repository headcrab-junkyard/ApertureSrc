...
void() enf_die3 = [$death3, enf_die4] {self.solid = SOLID_NOT;self.ammo_cells = 5;DropBackpack(); };
...
void() enf_fdie3 = [$fdeath3, enf_fdie4] {self.solid = SOLID_NOT;self.ammo_cells = 5;DropBackpack(); };
