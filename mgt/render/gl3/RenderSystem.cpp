...
====================
*/
void CRenderSystemLocal::RenderCommandBuffers(const emptyCommand_t *const cmdHead)
{
...
/*
=============
CRenderSystemLocal::CRenderSystemLocal
=============
*/
CRenderSystemLocal::CRenderSystemLocal()
...
/*
=============
CRenderSystemLocal::SetColor
=============
*/
void CRenderSystemLocal::SetColor(const idVec4 &rgba)
{
...
/*
=============
CRenderSystemLocal::GetColor
=============
*/
uint32 CRenderSystemLocal::GetColor()
{
...
/*
=============
CRenderSystemLocal::SetGLState
=============
*/
void CRenderSystemLocal::SetGLState(const uint64 glState)
{
...
/*
=============
CRenderSystemLocal::DrawFilled
=============
*/
void CRenderSystemLocal::DrawFilled(const idVec4 &color, float x, float y, float w, float h)
{
	SetColor(color);
...
/*
=============
CRenderSystemLocal::DrawStretchPic
=============
*/
void CRenderSystemLocal::DrawStretchPic(float x, float y, float w, float h, float s1, float t1, float s2, float t2, const idMaterial *material)
{
...
void CRenderSystemLocal::DrawStretchPic(const idVec4 &topLeft, const idVec4 &topRight, const idVec4 &bottomRight, const idVec4 &bottomLeft, const idMaterial *material)
{
	if(!R_IsInitialized())
	{
		return;
...
/*
=============
CRenderSystemLocal::DrawStretchTri
=============
*/
void CRenderSystemLocal::DrawStretchTri(const idVec2 &p1, const idVec2 &p2, const idVec2 &p3, const idVec2 &t1, const idVec2 &t2, const idVec2 &t3, const idMaterial *material)
{
	if(!R_IsInitialized())
	{
		return;
...
/*
=============
CRenderSystemLocal::AllocTris
=============
*/
idDrawVert *CRenderSystemLocal::AllocTris(int numVerts, const triIndex_t *indexes, int numIndexes, const idMaterial *material, const stereoDepthType_t stereoType)
{
...
/*
=====================
CRenderSystemLocal::DrawSmallChar

small chars are drawn at native screen resolution
=====================
*/
void CRenderSystemLocal::DrawSmallChar(int x, int y, int ch)
{
	int row, col;
	float frow, fcol;
	float size;
...
/*
==================
CRenderSystemLocal::DrawSmallStringExt
...
==================
*/
void CRenderSystemLocal::DrawSmallStringExt(int x, int y, const char *string, const idVec4 &setColor, bool forceColor)
{
	idVec4 color;
...
/*
=====================
CRenderSystemLocal::DrawBigChar
=====================
*/
void CRenderSystemLocal::DrawBigChar(int x, int y, int ch)
{
	int row, col;
	float frow, fcol;
	float size;
...
/*
==================
CRenderSystemLocal::DrawBigStringExt
...
==================
*/
void CRenderSystemLocal::DrawBigStringExt(int x, int y, const char *string, const idVec4 &setColor, bool forceColor)
{
	idVec4 color;
	const char *s;
	int xx;
...
/*
====================
CRenderSystemLocal::SwapCommandBuffers
...
====================
*/
const emptyCommand_t *CRenderSystemLocal::SwapCommandBuffers(
...
/*
=====================
CRenderSystemLocal::SwapCommandBuffers_FinishRendering
=====================
*/
void CRenderSystemLocal::SwapCommandBuffers_FinishRendering(
uint64 *frontEndMicroSec,
uint64 *backEndMicroSec,
uint64 *shadowMicroSec,
uint64 *gpuMicroSec)
...
/*
=====================
CRenderSystemLocal::SwapCommandBuffers_FinishCommandBuffers
=====================
*/
const emptyCommand_t *CRenderSystemLocal::SwapCommandBuffers_FinishCommandBuffers()
{
	if(!R_IsInitialized())
	{
		return NULL;
...
/*
=====================
CRenderSystemLocal::WriteDemoPics
=====================
*/
void CRenderSystemLocal::WriteDemoPics()
{
...
/*
=====================
CRenderSystemLocal::DrawDemoPics
=====================
*/
void CRenderSystemLocal::DrawDemoPics()
{
}

/*
=====================
CRenderSystemLocal::GetCroppedViewport

Returns the current cropped pixel coordinates
=====================
*/
void CRenderSystemLocal::GetCroppedViewport(idScreenRect *viewport)
{
...
/*
========================
CRenderSystemLocal::PerformResolutionScaling
...
========================
*/
void CRenderSystemLocal::PerformResolutionScaling(int &newWidth, int &newHeight)
{
	float xScale = 1.0f;
	float yScale = 1.0f;
...
/*
================
CRenderSystemLocal::CropRenderSize
================
*/
void CRenderSystemLocal::CropRenderSize(int width, int height)
{
	if(!R_IsInitialized())
	{
		return;
...
/*
================
CRenderSystemLocal::UnCrop
================
*/
void CRenderSystemLocal::UnCrop()
{
	if(!R_IsInitialized())
	{
		return;
	...
	{
		common->Error("CRenderSystemLocal::UnCrop: currentRenderCrop < 1");
	}
...
/*
================
CRenderSystemLocal::CaptureRenderToImage
================
*/
void CRenderSystemLocal::CaptureRenderToImage(const char *imageName, bool clearColorAfterCopy)
{
	if(!R_IsInitialized())
	{
		return;
...
/*
==============
CRenderSystemLocal::CaptureRenderToFile
==============
*/
void CRenderSystemLocal::CaptureRenderToFile(const char *fileName, bool fixAlpha)
{
	if(!R_IsInitialized())
	{
		return;
...
/*
==============
CRenderSystemLocal::AllocRenderWorld
==============
*/
idRenderWorld *CRenderSystemLocal::AllocRenderWorld()
{
...
/*
==============
CRenderSystemLocal::FreeRenderWorld
==============
*/
void CRenderSystemLocal::FreeRenderWorld(idRenderWorld *rw)
{
	if(primaryWorld == rw)
...
/*
==============
CRenderSystemLocal::PrintMemInfo
==============
*/
void CRenderSystemLocal::PrintMemInfo(MemInfo_t *mi)
{
	// sum up image totals
...
/*
===============
CRenderSystemLocal::UploadImage
===============
*/
bool CRenderSystemLocal::UploadImage(const char *imageName, const byte *data, int width, int height)
{
	idImage *image = globalImages->GetImage(imageName);
	if(!image)
	{
